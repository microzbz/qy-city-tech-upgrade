...
const routes = [
  ...
  { path: '/sso', component: () => import('../views/SsoCallbackView.vue') },
  {
    ...
    children: [
      ...
      { path: '/approvals/submission-view/:id', component: () => import('../views/EnterpriseSubmissionView.vue'), meta: { roles: ['APPROVER_ADMIN', 'SYS_ADMIN', 'TOWN_MONITOR'] } },
      { path: '/approvals/todo', component: () => import('../views/ApprovalTodoView.vue'), meta: { roles: ['APPROVER_ADMIN', 'SYS_ADMIN', 'TOWN_MONITOR'] } },
      { path: '/approvals/done', component: () => import('../views/ApprovalDoneView.vue'), meta: { roles: ['APPROVER_ADMIN', 'SYS_ADMIN', 'TOWN_MONITOR'] } },
      { path: '/admin/workflow', component: () => import('../views/WorkflowTemplateView.vue'), meta: { roles: ['SYS_ADMIN'] } },
      { path: '/admin/users', component: () => import('../views/UserManagementView.vue'), meta: { roles: ['SYS_ADMIN'] } },
